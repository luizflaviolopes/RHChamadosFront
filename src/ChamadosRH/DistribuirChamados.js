...
export class DistribuirChamados extends Component {
    ...
    handleDistribuirChamados = () => {
        api("api/Responsavel/distribuir", {
            ...
            .catch(
                toast.error("Não foi possivel distribuir chamados, tente novamente.")
            )
    }
        ...
        return (
            ...
            >
                ...
                <Modal.Body>
                    <Form.Group>
                        <Form.Label>
                            Atendentes Para Distribuir Chamados:
                        </Form.Label>
                    </Form.Group>
                ...
                <Modal.Footer>
                    <Button variant="success" onClick={() => this.handleDistribuirChamados}>Confirmar</Button>
